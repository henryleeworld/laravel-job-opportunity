    ...
    <div class="container">
        <div class="row fullscreen d-flex align-items-center justify-content-center">
            <div class="banner-content col-lg-12">
                <h1 class="text-white">
                    <span>1500+</span> 上週發佈職缺機會				
                </h1>	
                <form action="{{ route('search') }}" class="serach-form-area">
                    <div class="row justify-content-center form-wrap">
                        <div class="col-lg-4 form-cols">
                            <input type="text" class="form-control" name="search" placeholder="請問你在找什麼？">
                        </div>
                        ...
                        <div class="col-lg-2 form-cols">
                            <button type="submit" class="btn btn-info">
                              <span class="lnr lnr-magnifier"></span> 搜尋
                            </button>
                        </div>								
                    </div>
                </form>	
                <p class="text-white"> <span>類別搜尋：</span>
...
<div class="col-lg-8 post-list">
    ...
    <a class="text-uppercase loadmore-btn mx-auto d-block" href="{{ route('jobs.index') }}">載入更多發佈職缺</a>
</div>	
@endsection